...
{
    public partial class EditEnrollment
    {
        [Inject]
        ...
        {
            enrollment = await UniversityService.GetenrollmentByEnrollmentId(enrollment_id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await UniversityService.Updateenrollment(enrollment_id, enrollment);
